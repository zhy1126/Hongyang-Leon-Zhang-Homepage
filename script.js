...
const zhTranslations = {
  ...
  "hero.statement": "让问题在这里相遇。",
  "hero.lede": "我关注个体、制度与城市如何应对风险，尤其关注数据与人工智能介入后，决策过程会发生怎样的变化。",
  "education.cambridge_degree": "犯罪学哲学硕士（MPhil）",
  "education.cambridge_school": "剑桥大学",
  "education.zuel_degree": "侦查学法学学士",
  ...
  "publication.one.authors": "Xiaobing Luan 与 <strong>张宏扬</strong>",
  "publication.one.venue": "<em>中国刑警学院学报</em>，(5)，40–47。",
  "publication.two.title": "预测性警务情境下执法启动的程序控制",
  "publication.two.authors": "Xiaobing Luan 与 <strong>张宏扬</strong>",
  ...
  "honor.one.type": "创新创业",
  "honor.one.title": "铜奖",
  "honor.one.body": "中国国际大学生创新大赛",
  "honor.two.type": "数学建模",
  "honor.two.title": "三等奖",
  "honor.two.body": "MathorCup 高校数学建模挑战赛",
  "honor.three.type": "犯罪学",
  "honor.three.title": "三等奖",
  "honor.three.body": "湖北省犯罪学研究会年会",
  "honor.four.type": "学业表现",
  "honor.four.title": "二等奖学金",
  "honor.four.body": "学校年度奖学金 · 连续三年",
  "contact.index": "05 / 联系",
  "contact.title": "欢迎交流。",
